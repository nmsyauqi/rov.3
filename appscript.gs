function doPost(e) {
  ...
  try {
    ...
    if (udara < 0 || udara > 100)
      pesan.push("Kualitas Udara tidak wajar: " + udara);
    if (tanah < 0 || tanah > 100)
      pesan.push("Kualitas Tanah tidak wajar: " + tanah);
    if (listrik < 0 || listrik > 220)
      pesan.push("Daya Listrik tidak wajar: " + listrik);
